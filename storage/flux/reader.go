...
func (w qWAC) HaveMin() bool    { return false }
func (w qWAC) HaveMax() bool    { return false }
func (w qWAC) HaveMean() bool   { return true }
func (w qWAC) HaveCount() bool  { return false }
func (w qWAC) HaveSum() bool    { return false }
func (w qWAC) HaveFirst() bool  { return false }
func (w qWAC) HaveLast() bool   { return false }
func (w qWAC) HaveOffset() bool { return true }
	...
	for rs.Next() {
		...
		case cursors.IntegerArrayCursor:
			if !selector {
				...
				return &influxdb.Error{
					Code: influxdb.EInternal,
					Msg:  "window selector not supported",
				}
			} else {
				return &influxdb.Error{
					Code: influxdb.EInternal,
